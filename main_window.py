...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_9.addWidget(self.cvResults)
        ...
        self.horizontalLayout_6.addWidget(self.btSaveResults)
        self.btSaveGraph = QtWidgets.QPushButton(self.centralwidget)
        self.btSaveGraph.setEnabled(False)
        self.btSaveGraph.setObjectName("btSaveGraph")
        self.horizontalLayout_6.addWidget(self.btSaveGraph)
